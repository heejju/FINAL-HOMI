	...
	<div class="wrapper">
		<form id="myInfoForm">
			...
			<table id="myInfoGTable">
				...
				<tr><td class="myInfo_td"><br><br></td></tr>
				<tr>
					<th><div id="buttonB_infoG_th" style="background-color: #888c43;">아이디</div></th>
				...
				<tr><td class="myInfo_td"><br><br></td></tr>
				<tr>
					<th><div id="buttonB_infoG_th">이메일</div></th>
					<td class="myInfo_td" colspan="2">
						<input type="text" id="email" name="email" class="infoInputG" value="${loginUser.email}" readonly>
						<input type="hidden" id="email" name="email" value="${loginUser.email}"><br>
					</td>
				</tr>
				<tr><td class="myInfo_td"><br><br></td></tr>
				<tr>
					<th><div id="buttonB_infoG_th" style="margin-bottom: 25%; background-color: #888c43;">기본 주소</div></th>
					<td class="myInfo_td" colspan="2">
						<script>
							$(document).ready(function() {
				...
				<tr><td class="myInfo_td"><br><br></td></tr>
				<tr>
					<th><div id="buttonB_infoG_th">가입일자</div></th>
					<td class="myInfo_td" colspan="2">
				...
				<tr><td class="myInfo_td"><br><br></td></tr>
				<tr>
					<th><div id="buttonB_infoG_th" style="background-color: #888c43;">회원종류</div></th>
					<td class="myInfo_td" colspan="2">
						<script>
							$(document).ready(function() {
