		...
		<div class="header">
			...
			<div class="firstInfo">
				...
				<p class="info-categori">
					...
					<input class="hobbySelInputText" type="text" id="hobbyName" style="width:200px" placeholder="취미선택" readonly onclick="window.open('${HBSel}', 'hobbyPopup', 'width=1100px, height=800px, menubar=no, status=no, toolbar=no, resizable=no');">
