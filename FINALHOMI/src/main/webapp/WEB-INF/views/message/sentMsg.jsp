		...
		<table id="msgTable" style="table-layout: fixed;">
			...
			<c:forEach var="m" items="${list}">
				<tr>
					...
					<td style="text-overflow:ellipsis; overflow:hidden; white-space:nowrap;" id="to" class="tr-no"> ${ m.msg_to } </td>
	...
	<div>
		<div id="pagingArea" style="position: relative; text-align: center;">
            ...
            <c:if test="${ pi.currentPage > 1 }">
               ...
               <a href="${ before }"><button style="font-wieght:bold; background:#675141; color:white;" id="before">&lt;</button></a>
            </c:if>
            ...
            <c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }">
               ...
               <c:if test="${ p ne pi.currentPage }">
                  <c:url var="pagination" value="sentMsgList.msg">
		...
		/* 마우스 오버 효과 */
			...
			$(function(){
	         	$('.tr-no').click(function(){
	         		...
	         		var to = $(this).parent("tr").find("#to").text();
	         		location.href="detail.msg?mNo=" + mNo + "&page=" + ${pi.currentPage} + "&msg_to=" + to + "&msg_from=false";
	         	});
	         });
