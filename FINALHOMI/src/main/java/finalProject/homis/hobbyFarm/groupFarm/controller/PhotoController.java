...
import finalProject.homis.hobbyFarm.groupFarm.model.vo.PhotoVo;
...
public class PhotoController {
	...
	public String photoUpload(HttpServletRequest request, PhotoVo vo, HttpServletResponse response) {
		...
		try {
			if(vo.getFiledata() != null && vo.getFiledata().getOriginalFilename() != null && !vo.getFiledata().getOriginalFilename().equals("")) {
				...
				String ext = original_name.substring(original_name.lastIndexOf(".") + 1); //확장자 명
				// 파일 기본경로
	...
	public void multiplePhotoUpload(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			sFileInfo += "&sFileURL=" + "/hobbyFarm/resources/photo_upload/" + realFileNm;
