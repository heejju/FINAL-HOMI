			...
			<div id="postMain">
				<form action="insert.gf" id="form" method="post" enctype="Multipart/form-data" accept-charset="UTF-8">
					<div class="thumbnailWrapper">
						...
						<div id="imgGuide">썸네일 이미지는 가로에 최적화 되어있습니다.</div>
					</div>
				...
				<div class="postWrapper"> 
					<div id="titleWrapper"><input type="text" placeholder="게시글 제목을 입력해주세요" name="title" id="title"></div><br>
					...
					<ul id="informList">
						...
						<li><b>요일</b> :
							...
							<script type="text/javascript">
								...
								$("input:checkbox[name=days]").change(function(){
									...
									/* $("input:checkbox[name=days]:checked").each(function(length, e) {
									    items.push($(this).val());
									}); */
						...
						<li>
							<b>지도 강사</b> : 
							<input type="radio" name="offerYN" value="Y" checked/>구인함
							<input type="radio" name="offerYN" value="N"/>구인안함
						</li>
					</ul>
				</div>
